...
[name], the newest addition to Contoso's AI team, brings a fresh perspective to the company's digital journey. His inaugural mission is both ambitious and exciting: to breathe new life into a legacy to-do app. [name] aims to infuse this app with the power of Generative AI, making it more attuned to the needs of today's customers. While [name] possesses some knowledge of OpenAI on Azure and CosmosDB, he's not yet an expert in these domains. To bridge the gap, he's placing his trust in GitHub Copilot, an innovative AI-driven coding companion.  

As he dives into the world of AI-infused applications, the suspense lingers—will [name] succeed, and will Copilot be the ace up his sleeve? 
...
- Azd up on main branch
- Scroll up readme
- Cut notifications
- Deploy final version
- Deploy version without OpenAI on another region

### Intro

- Explain the context:
  * You're right, I joined this new team working on modernizing this app. Well, you all know how it is, right?

- Show existing TODO app

  * This app seems nothing fancy: it's a todo app. And I was asked to add some AI to it.
...
- First, I'll use GitHub Codespaces to have a ready-to-use dev environment.
...
- Copilot in VS Code comes in different forms and at different places, as you'll see along the demo.
  ...
  * I'll show you throughout this session that using Copilot works the same as when you're pair-programming with on of your colleagues.
...
! We're a bit short on time, so I did ask one of my colleagues to help me with the frontend part so let's have a look at what he did.
...
- Also regarding security in CI, GitHub advanced Security is enabled in the repo, so if there are issues in the NPM dependency, of I someone tries to push a secret key in the code, it will be detected.
...
- That's it for the demo! You've seen how Copilot helped me with this project to get into this project and add generative AI to it very quickly.

### Variant with +5min for full frontend implementation
